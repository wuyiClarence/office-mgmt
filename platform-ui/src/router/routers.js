...
export default [
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () => import('@/view/device/group.vue')
      }
    ]
  },
  {
  ...
  },
  {
    ...
    children: [
      {
        path: 'public_namespace',
        name: 'public_namespace',
        meta: {
          icon: 'ios-folder-open-outline',
          title: '公共空间'
        },
        component: () => import('@/view/document/public_namespace.vue')
      },
      {
        path: 'person_namespace',
        name: 'person_namespace',
        meta: {
          icon: 'md-folder-open',
          title: '个人空间'
        },
